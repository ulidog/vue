  ...
  <section>
    <div class="dialog-footer">
      <div class="other-login">
        ...
        <div class="right">
          <!-- 电话 -->
          <span class="icon" v-if="Number(phoneEmail) === 1 && whichPage !== 'sign'" @click="changePhoneEmail(1)">
            <!-- <i class="fa fa-google fa-1x" @click="otherLogin('google')"></i> -->
            <img src="/static/img/account/phone.png" alt="">
          </span>
           <!-- 邮箱 -->
          <span class="icon" v-if="Number(phoneEmail) === 2 && whichPage !== 'sign'" @click="changePhoneEmail(2)">
            <!-- <i class="fa fa-google fa-1x" @click="otherLogin('google')"></i> -->
            <img src="/static/img/account/email.png" alt="">
          </span>
          <span class="icon">
            <!-- <i class="fa fa-google fa-1x" @click="otherLogin('google')"></i> -->
            <img src="/static/img/common/account/google1.png" @click="otherLogin('google')" alt="">
          </span>
          <span class="icon">
            <!-- <i class="fa fa-twitter-square fa-1x" @click="otherLogin('twitter')"></i> -->
            <img src="/static/img/common/account/twitter1.png" @click="otherLogin('twitter')" alt="">
          </span>
          <span class="icon">
            <!-- <i class="fa fa-facebook-official fa-1x" @click="otherLogin('facebook')"></i> -->
            <img src="/static/img/common/account/facebook1.png" @click="otherLogin('facebook')" alt="">
          </span>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    otherLogin (type) {
      ...
      provider.login().then((res) => {
        ...
        this.$message.error(type.charAt(0).toUpperCase() + type.slice(1) + ' Login Failed, please try again!')
        // console.log(e)
      }).then((res) => {
      ...
      this.$axios({
        ...
        .then(response => {
          ...
          if (data.success) {
            ...
            this.$message.success(this.otherLoginData.type.charAt(0).toUpperCase() + this.otherLoginData.type.slice(1) + ' Login Successful')
            this.$emit('toggleLayer', false)
          } else {
            this.$message.error(this.otherLoginData.type.charAt(0).toUpperCase() + this.otherLoginData.type.slice(1) + ' Login Failed, please try again!')
