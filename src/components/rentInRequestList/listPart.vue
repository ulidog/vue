...
<template>
  <div class="list-part-container" v-loading="loading">
    <div class="list-part-brow">
      <button class="active">Renting request</button>
      <router-link to="/buyRequestList" tag="button">Buying Request</router-link>
      ...
      <div class="info-unit" v-for="(unit, index) in listData" :key="unit.id" @click="gotoDetail(unit)">
        ...
        <div class="info-wrap">
          ...
          <div class="row">
            ...
            <div class="price-range">${{unit.priceMin}}-{{unit.priceMax}}/mo</div>
          </div>
          <div class="row">
            <div class="label">
              <span v-if="unit.releaseType === 1" class="whole-house-label">Whole house</span>
              <span v-if="unit.releaseType === 2" class="single-room-label">Single room</span>
...
export default {
  ...
  'methods': {
    ...
    collect (_event, _dataUnit, _index) {
      ...
      this.$axios({
        ...
        'data': {
          ...
          'collectionType': _dataUnit.releaseType
        }
      })
        .then(response => {
          const data = response.data
    ...
    cancelCollect (_event, _dataUnit, _index) {
