...
export default {
  ...
  render (h) {
    ...
    const TEMPLATE_MAP = {
      ...
      slota: <my-slota></my-slota>,
      slotb: <my-slotb></my-slotb>,
      total: <total></total>
    }
  ...
  components: {
    MySlota: {
      render (h) {
        return (
          this.$parent.$slots.slota
            ? this.$parent.$slots.slota[0]
            : ''
        )
      }
    },
    MySlotb: {
      render (h) {
        return (
          this.$parent.$slots.slotb
            ? this.$parent.$slots.slotb[0]
            : ''
        )
      }
    },
