<template>
  <el-row class="step_09_Views">
    <el-col :span="24" class="content">
      <section class="success-status">
        <h4 v-show="!isSuccessStatus">The Buyer has submitted the application for Early Rental Termination. Please upload the Proof of Refund.</h4>
...
export default {
  ...
  created () {
    ...
    if (Number(this.params.state) === 13) {
      this.isSuccessStatus = false
    } else if (Number(this.params.state) === 14) {
  ...
  methods: {
    ...
    _ConfirmChange () {
      ...
      const paramsFrom = Object.assign({}, ...uploadImg, {houseOrderId: _this.params.id, type: 5})
