<template>
  <el-row class="step_08_Views">
    ...
    <el-col :span="24" class="content">
      <tenant-view-reason :reasonTip="reasonTip" :valueNull="true" :isShowTextarea="false"></tenant-view-reason>
    </el-col>
        ...
        .then(res => {
          if (res.data.success) {
            ...
            if (res.data.data.saleHouseOrderRecordingInfoTwo) {
              _this.reasonTip = res.data.data.saleHouseOrderRecordingInfoTwo.denialReason
            }
          }
          // console.info(res)
        })
