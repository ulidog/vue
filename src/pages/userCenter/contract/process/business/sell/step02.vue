<template>
  <el-row class="step_02_Views">
    ...
    <el-col :span="24" class="btn-submit">
      <sell-confirm-and-reject @confirmChange="ConfirmChange" @rejectChange="RejectChange" :isDisabled="[noSubmit, false]" :ConfirmLoading="ConfirmLoading"></sell-confirm-and-reject>
    </el-col>
...
export default {
  ...
  data () {
    return {
      ...
      // 传统交易 OR SFT
      titlesTypeList: ['This is a SFT contract and the Buyer is waiting for you to sign.', 'This is a traditional contract and the Buyer is waiting for you to sign.'],
      step2From: {
        signature: false,
        cardType: 0
      },
