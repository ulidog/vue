<template>
  <el-row class="step_05_base_Views">
    ...
    <el-col :span="24" class="content">
      <sell-view-reason :isShowTextarea="false" :reasonTip="reasonTip"></sell-view-reason>
    </el-col>
      ...
      _this.$axios.get(`${this.WXL_LOCAL_PATH}saleHouseOrder/find_offer_detail`, {params: {saleHouseOrderId: _this.params.id, state: _this.params.oldState ? _this.params.oldState : null}})
        .then(res => {
          if (res.data.success) {
            ...
            if (!_this.$route.params.msg) {
              if (res.data.data.saleHouseOrderRecordingInfo !== undefined) {
                this.reasonTip = res.data.data.saleHouseOrderRecordingInfo.denialReason
              }
              if (res.data.data.saleHouseOrderRecordingInfoTwo !== undefined) {
                this.reasonTip = res.data.data.saleHouseOrderRecordingInfoTwo.denialReason
              }
            }
          }
          // console.info(res)
