...
export default {
  ...
  created () {
    ...
    if (Number(this.params.state) === 27 || Number(this.params.state) === 34) {
      this.isSuccessStatus = false
    } else if (Number(this.params.state) === 28 || Number(this.params.state) === 32) {
  ...
  methods: {
    ...
    _ConfirmChange () {
      ...
      const paramsFrom = Object.assign({}, ...uploadImg, {houseOrderId: _this.params.id, type: _this.params.state === 27 ? 11 : 12})
