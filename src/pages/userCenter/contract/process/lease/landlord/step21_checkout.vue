  ...
  <el-row class="step_21_Views">
    <el-col :span="24" class="content">
      <header class="title-tip">
        <h3 v-show="!isSuccessStatus">The tenant has paid the rent and you have confirmed the receipt</h3>
      ...
      <footer class="submit-btns" v-show="!isSuccessStatus">
        <landlord-confirm-and-reject @confirmChange="_confirm" @rejectChange="_reject" :confirmTitle="'Collect the rent'" :rejectTitle="'Early recovery of housing'" :ConfirmLoading="ConfirmLoading"></landlord-confirm-and-reject>
      </footer>
    </el-col>
  </el-row>
</template>
