<template>
  <el-row class="step_18_Views">
    ...
    <el-col :span="24" class="content">
      <landlord-view-reason :reasonTip="reasonFrom.reasonMsg" @reasonFrom="reasonFromChange" :isShowTextarea="false"></landlord-view-reason>
      <landlord-submit @ConfirmChange="_confirm" :ConfirmLoading="ConfirmLoading" :submitTitle="'Fill in again'"></landlord-submit>
    </el-col>
  </el-row>
</template>
<script>
