<template>
  <el-row class="step_02_Views">
    <el-col :span="24" class="content">
      <section class="isFileTip">
        <header class="tip_title">
          <h3>You received a rental contract and waiting for your signature</h3>
        </header>
      ...
      <section class="TermsCanvas">
        ...
        <section class="signatureBrod">
          <section class="bg_box">
            <img v-lazy="userSignatureInfo" v-if="step2From.signature" alt="" @click="openSigntrue" :key="Math.random() * 10000">
          </section>
        </section>
      </section>
      <!-- <section class="TermsCanvas" v-else>
        ...
        <section class="signatureBrod">
          <section class="bg_box">
            <img v-lazy="userSignatureInfo" v-if="step2From.signature" alt="" :key="Math.random() * 10000">
          </section>
        </section>
      </section> -->
    ...
    <el-col :span="24" class="btn-submit" v-if="isOldShow">
      <section class="Confirm">
        ...
        <el-button type="danger" class="btns" @click="RejectChange" plain>Reject</el-button>
      </section>
    </el-col>
