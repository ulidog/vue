  ...
  <el-row class="step_05_Views">
    <el-col :span="24" class="content">
      <section class="success-status">
        <h4 v-show="!isSuccessStatus">The tenant has submitted the refund application, please upload the proof of refund.</h4>
        <h4 v-show="isSuccessStatus">Congratulations to you! Upload successful!</h4>
      </section>
      <header class="titles-img-size">
        <h3>Rent and deposit: ${{ Number(params.monthlyRent) + Number(params.deposit) }}</h3>
...
export default {
  ...
  methods: {
    ...
    _ConfirmChange () {
      ...
      const paramsFrom = Object.assign({}, ...uploadImg, {houseOrderId: _this.params.id, type: 8})
