  ...
  <div class="part-container">
    <div class="list-container">
      <div class="info-unit" v-for="(unit, index) in collectionData" :key="index" @click="gotoDetail(unit)">
        ...
        <div class="btn-group">
          <el-button @click.stop="soldOut(unit.id)">Sold</el-button>
    ...
    <el-pagination v-if="dataTotal > pageSize" class="clear" background layout="prev, pager, next" :page-size="pageSize" :total="dataTotal"
  ...
  'methods': {
    ...
    soldOut (_id) {
      this.$confirm('Confirm the removal?', 'Tip', {}).then(() => {
        this.$axios({
          'method': 'post',
          'url': `${this.zjc_path}updateHouseNeed`,
          'data': {
            'id': _id,
            'isEnable': 3,
            'checkStatus': 4
