  ...
  <div class="part-container">
    <div class="list-container">
      <div class="info-unit" v-for="(unit, index) in historyData" :key="index"  @click="gotoDetail(unit)">
        <img class="rent-in-type-flag" v-if="'whole' === unit.type" src="/static/img/userCenter/whole_house_logo.png" />
        <img class="rent-in-type-flag" v-if="'single' === unit.type" src="/static/img/userCenter/single_room_logo.png" />
        <div class="avatar">
