...
export default {
  ...
  'methods': {
    ...
    view (_unit) {
      ...
      this.$router.push({
        name: 'process-null',
        query: {ebuyhouse: this.$base64.encode(JSON.stringify({id: _unit.offerId, type: _unit.dealType === 1 ? 0 : 1, types: 0}))},
        params: {id: _unit.offerId, type: _unit.dealType === 1 ? 0 : 1, types: 0}
      })
    },
