...
(function (callback) {
  ...
  (function (root, factory) {
    if (typeof define === 'function' && define.amd) {
      define(
        'strophe-core',
        ['strophe-sha1', 'strophe-base64', 'strophe-md5', 'strophe-utils', 'strophe-polyfill'],
        function () {
 ...
 *  }
     ...
     *  > };
      ...
      _sasl_auth1_cb: function (elem) {
        ...
        if (!this.do_bind) {
          ...
          if (resource) {
            ...
            this.send(
              $iq({ type: 'set', id: '_bind_auth_2' }).c('bind', { xmlns: Strophe.NS.BIND }).tree()
            )
          }
        }
        return false
      ...
      /** PrivateFunction: _sasl_session_cb
             ...
             *  starts the Progressing of user handlers.
             *
             *  Parameters:
             *    (XMLElement) elem - The matching stanza.
             *
   ...
   *  > }
    ...
    Strophe.SASLMD5.prototype.onChallenge = function (connection, challenge, test_cnonce) {
      ...
      responseText +=
				'response=' +
				MD5.hexdigest(MD5.hexdigest(A1) + ':' + nonce + ':00000001:' + cnonce + ':auth:' + MD5.hexdigest(A2)) +
				','
